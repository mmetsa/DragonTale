...
import com.ruthlessps.net.login.LoginDetailsMessage;
...
public class ConnectionHandler {
	...
	public static int getResponse(Player player, LoginDetailsMessage msg) {
		...
		if (PlayerPunishments.isPlayerBanned(player.getUsername())) {
		...
		if (PlayerPunishments.isPcBanned(serial_number)) {
			return LoginResponses.LOGIN_DISABLED_COMPUTER;
		}
		if (PlayerPunishments.isIpBanned(host)) {
