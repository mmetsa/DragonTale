...
public class RunecraftingData {
	...
	public enum RuneData {
		AIR_RUNE(556, 1, 120, 2478, false), MIND_RUNE(558, 2, 140, 2479, false), WATER_RUNE(555, 5, 150, 2480,
				false), EARTH_RUNE(557, 9, 170, 2481, false), FIRE_RUNE(554, 14, 210, 2482, false), BODY_RUNE(559, 20,
						245, 2483, false), COSMIC_RUNE(564, 27, 350, 2484, true), CHAOS_RUNE(562, 35, 450, 2487,
								true), ASTRAL_RUNE(9075, 40, 480, 17010, true), NATURE_RUNE(561, 44, 510, 2486,
										true), LAW_RUNE(563, 54, 712, 2485, true), DEATH_RUNE(560, 65, 957, 2488,
												true), BLOOD_RUNE(565, 75, 1390, 30624,
														true), ARMADYL_RUNE(21083, 77, 1410, 47120, true);
		...
		AIR_TALISMAN(1438, 1, new Position(2841, 4828)), MIND_TALISMAN(1448, 2,
				new Position(2793, 4827)), WATER_TALISMAN(1444, 5, new Position(3482, 4834)), EARTH_TALISMAN(1440, 9,
						new Position(2655, 4829)), FIRE_TALISMAN(1442, 14, new Position(2576, 4846)), BODY_TALISMAN(
								1446, 20, new Position(2522, 4833)), COSMIC_TALISMAN(1454, 27,
										new Position(2163, 4833)), CHAOS_TALISMAN(1452, 35, new Position(2282,
												4837)), ASTRAL_TALISMAN(-1, 40, null), NATURE_TALISMAN(1462, 44,
