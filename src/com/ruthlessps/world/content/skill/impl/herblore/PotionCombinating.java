...
public class PotionCombinating {
	...
	public enum CombiningDoses {
		 ...
		 *            - This is the ID for the potion when it contains two doses.
		 * 
		 * @param threeDosePotionID
		 *            - This is the ID for the potion when it contains three doses.
		 * 
		 * @param fourDosePotionID
		 *            - This is the ID for the (full) potion when it contains four
		 *            doses.
		 * 
		 * @param vial
		 *            - This is referenced from: private static final int VIAL = 227;
		 *            It's a constant and its value never changes.
		 * 
		 * @param potionName
		 *            - This is a string which is used to set a name for the potion.
		 *            Within an enumeration you can use the name(). method to take the
		 *            name in-front of the stored data. This however could not be done
		 *            because of some potion names.
		 */
