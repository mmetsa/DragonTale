...
public class Scoreboards {
	...
	public static ArrayList<ScoreboardEntry> getUpdatedList(Scoreboard scoreboard) {
		...
		for (Player p : World.getPlayers()) {
			...
			if (scoreboard == Scoreboards.TOP_PKERS) {
				...
				entries.add(new ScoreboardEntry(p.getUsername(),
						new String[] { String.valueOf(p.getPointsManager().getPoints("achievement")) }));
			}
		}
	...
	public static void init() {
		TOP_PKERS = new Scoreboard(GameSettings.SERVER_NAME + " Top Pkers", "top-pkers.txt") {
			@Override
		...
		TOP_KILLSTREAKS = new Scoreboard(GameSettings.SERVER_NAME + " Top Killstreaks", "top-killstreaks.txt") {
			@Override
			public void resort(ArrayList<ScoreboardEntry> entries) {
		...
		TOP_ACHIEVER = new Scoreboard(GameSettings.SERVER_NAME + " Top Achiever", "top-achievers.txt") {
			@Override
			public void resort(ArrayList<ScoreboardEntry> entries) {
				Scoreboards.resort(entries, "integer");
			}
		...
		TOP_TOTAL_EXP = new Scoreboard(GameSettings.SERVER_NAME + " Top Total Exp", "top-exp.txt") {
			@Override
			public void resort(ArrayList<ScoreboardEntry> entries) {
