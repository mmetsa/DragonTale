...
public class Artifacts {
	 ...
	 * 
	 * @param Player
	 *            player Player who has killed Player o
	 * @param Player
	 *            o Player who has been killed by Player player
	 */
	public static void handleDrops(Player killer, Player death, boolean targetKill) {
		...
		if (Misc.getRandom(100) >= 99) {
			...
			World.sendMessage("<col=009966> " + killer.getUsername() + " has just received " + Misc.anOrA(itemName)
