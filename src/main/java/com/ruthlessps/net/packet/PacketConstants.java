package com.ruthlessps.net.packet;

import com.ruthlessps.net.packet.impl.ButtonClickPacketListener;
import com.ruthlessps.net.packet.impl.ChangeAppearancePacketListener;
import com.ruthlessps.net.packet.impl.ChangeRelationStatusPacketListener;
import com.ruthlessps.net.packet.impl.ChatPacketListener;
import com.ruthlessps.net.packet.impl.ClickTextMenuPacketListener;
import com.ruthlessps.net.packet.impl.CloseInterfacePacketListener;
import com.ruthlessps.net.packet.impl.DialoguePacketListener;
import com.ruthlessps.net.packet.impl.DropItemPacketListener;
import com.ruthlessps.net.packet.impl.DuelAcceptancePacketListener;
import com.ruthlessps.net.packet.impl.DungeoneeringPartyInvitatationPacketListener;
import com.ruthlessps.net.packet.impl.EnterInputPacketListener;
import com.ruthlessps.net.packet.impl.EquipPacketListener;
import com.ruthlessps.net.packet.impl.ExamineItemPacketListener;
import com.ruthlessps.net.packet.impl.ExamineNpcPacketListener;
import com.ruthlessps.net.packet.impl.FinalizedMapRegionChangePacketListener;
import com.ruthlessps.net.packet.impl.FollowPlayerPacketListener;
import com.ruthlessps.net.packet.impl.GambleInvitePacketListener;
import com.ruthlessps.net.packet.impl.HeightCheckPacketListener;
//import com.ruthlessps.net.packet.impl.IdleLogoutPacketListener;
import com.ruthlessps.net.packet.impl.ItemActionPacketListener;
import com.ruthlessps.net.packet.impl.ItemColorCustomization;
import com.ruthlessps.net.packet.impl.ItemContainerActionPacketListener;
import com.ruthlessps.net.packet.impl.MagicOnItemsPacketListener;
import com.ruthlessps.net.packet.impl.MagicOnPlayerPacketListener;
import com.ruthlessps.net.packet.impl.MovementPacketListener;
import com.ruthlessps.net.packet.impl.NPCOptionPacketListener;
import com.ruthlessps.net.packet.impl.ObjectActionPacketListener;
import com.ruthlessps.net.packet.impl.PickupItemPacketListener;
import com.ruthlessps.net.packet.impl.PlayerOptionPacketListener;
import com.ruthlessps.net.packet.impl.PlayerRelationPacketListener;
import com.ruthlessps.net.packet.impl.PrestigeSkillPacketListener;
import com.ruthlessps.net.packet.impl.ReceiveRewardListener;
import com.ruthlessps.net.packet.impl.RegionChangePacketListener;
import com.ruthlessps.net.packet.impl.SendClanChatMessagePacketListener;
import com.ruthlessps.net.packet.impl.SilencedPacketListener;
import com.ruthlessps.net.packet.impl.SwitchItemSlotPacketListener;
import com.ruthlessps.net.packet.impl.TradeInvitationPacketListener;
import com.ruthlessps.net.packet.impl.UseItemPacketListener;
import com.ruthlessps.net.packet.impl.WithdrawMoneyFromPouchPacketListener;
import com.ruthlessps.net.packet.impl.commands.CommandHandler;
...
public class PacketConstants {
	...
	static {
		...
		PACKETS[182] = new ReceiveRewardListener();
		...
		PACKETS[103] = new CommandHandler();
		...
		PACKETS[72] = new NPCOptionPacketListener();
		PACKETS[155] = new NPCOptionPacketListener();
		...
		PACKETS[137] = new GambleInvitePacketListener();
