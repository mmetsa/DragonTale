...
public class NpcDefinition {
	...
	public static JsonLoader parseNpcs() {
		return new JsonLoader() {
			...
			public void load(JsonObject reader, Gson builder) {
				...
				if(reader.has("has-superior")) {
					definitions[index].setSuperior(reader.get("has-superior").getAsBoolean());
				}
				if(reader.has("superior-id")) {
					definitions[index].setSuperiorId(reader.get("superior-id").getAsInt());
				}
				if(reader.has("is-superior")) {
					definitions[index].setIsSuperior(reader.get("is-superior").getAsBoolean());
				}
			}
		};
	}
	...
	/** Whether the NPC has a superior one. */
	...
	/**
	 * Gets if the NPC has a superior NPC.
	 */
	...
	/**
	 * Sets if this npc has a superior NPC.
	 * @param asBoolean
	 */
	public void setSuperior(boolean asBoolean) {
		this.superior = asBoolean;
		
	}
	public void setIsSuperior(boolean asBoolean) {
		this.isSuperior = asBoolean;
		
	}
	public void setSuperiorId(int id) {
		this.superiorId = id;
