...
// import com.ruthlessps.world.content.DropLog.DropLogEntry;
...
// int index = -1;
// index++;
// for(com.ruthlessps.drops.DropLog.DropLogEntry entry : player.getDropLog()) {
// if(entry.rareDrop) {
//
// player.getPacketSender().sendString(25261 + index, "@or1@
/// "+ItemDefinition.forId(entry.item).getName()+": @gre@x"+entry.amount+"");
// index++;
// }
// }
// } catch(Exception e) {
...
// index++;
// for(com.ruthlessps.drops.DropLog.DropLogEntry entry : player.getDropLog()) {
// player.getPacketSender().sendString(65261+index, "@or1@
/// "+ItemDefinition.forId(entry.item).getName()+":@gre@ x"+entry.amount+"");
// index++;
// }
// } catch(Exception e) {
...
// com.ruthlessps.drops.DropLog.DropLogEntry drop2 =
/// player.getDropLog().get(player.getDropLog().size() - 1);
