...
import com.ruthlessps.model.input.impl.EnterAmountOfBonesToSacrifice;
...
import com.ruthlessps.model.input.impl.EnterAmountToSpin;
...
public class ChatboxInterfaceSkillAction {
	...
	public static void handleChatboxInterfaceButtons(Player player, int buttonId) {
		if (!player.getClickDelay().elapsed(3000)
			...
			return;
		int amount = buttonId == 2799 ? 1 : buttonId == 2798 ? 5 : buttonId == 1747 ? 100000000 : -1;
