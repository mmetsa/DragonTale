...
public class MiningData {
	...
	public static enum Ores {
		...
		CRYSTALS(new int[] {57164}, 1, 1, 13147, 7, -1),
	...
	public enum Pickaxe {
		...
		Melee(16142, 1, 10226, 1.0),
		Magic(16143, 1, 10226, 1.0),
		Range(16144, 1, 10226, 1.0),
		Defence(16145, 1, 10226, 1.0),
		Money(16146, 1, 10226, 1.0),
		Dr(16147, 1, 10226, 1.0),
		Health(16148, 1, 10226, 1.0),
		Ddr(16149, 1, 10226, 1.0),
		Water(16307, 1, 10226, 1.0),
		Earth(16299, 1, 10226, 1.0),
		Fire(16305, 1, 10226, 1.0),
		Air(16303, 1, 10226, 1.0),
