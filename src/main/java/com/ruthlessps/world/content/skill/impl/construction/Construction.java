...
import com.ruthlessps.world.content.skill.impl.construction.ConstructionData.Butlers;
...
import com.ruthlessps.world.content.skill.impl.construction.ConstructionData.Portals;
...
public class Construction {
	...
	public static void enterHouse(final Player me, final Player houseOwner, final boolean buildingMode) {
		...
		Achievements.doProgress(me, AchievementData.ENTER_HOME);
	...
	public static String hasReqs(Player p, Furniture f, HotSpots hs) {
		...
		if (p.getRights() == PlayerRights.DEVELOPER)
			return null;
		if (p.getSkillManager().getCurrentLevel(Skill.ATTACK) < f.getLevel()) {
	...
	public static boolean buildActions(Player p, Furniture f, HotSpots hs) {
		...
		p.getSkillManager().addExperience(Skill.ATTACK, f.getXP());
		return true;
	}
	...
	public static boolean handleButtonClick(int buttonId, Player p) {
		...
		case 2461:
			...
			if (p.getDialogueActionId() == 444) {
				...
				if (p.getSkillManager().getCurrentLevel(Skill.ATTACK) < b.getConsLevel()) {
					DialogueManager.start(p,
