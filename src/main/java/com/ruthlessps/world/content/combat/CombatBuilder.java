...
public class CombatBuilder {
	...
	/**
	 * Prompts the controller to begin attacking the argued entity. Wilderness and
	 * multicombat checks are still applied, although later on in the process. If
	 * this controller is already attack
	 * 
	 * @param target
